...
// ****************************
// Move JS Files to booking/static/assets/js
// ****************************
...
gulp.task('js', function () {
    return gulp.src([
      ...
      'node_modules/jquery-ui-slider/jquery-ui.min.js'
        ...
        .pipe(gulp.dest("booking/static/assets/js"))
});
...
gulp.task('scripts', function () {
    return gulp.src([
    './booking/static/assets/js/default-assets/avoid.console.error.js',
    './booking/static/assets/js/default-assets/classy-nav.js',
    'node_modules/owl.carousel2/dist/owl.carousel.min.js',
    'node_modules/wowjs/dist/wow.min.js',
    'node_modules/magnific-popup/dist/jquery.magnific-popup.min.js',
    'node_modules/jquery-waypoints/waypoints.min.js',
    ...
    'node_modules/jarallax/dist/jarallax.min.js',
    'node_modules/jarallax/dist/jarallax-video.min.js',
    './booking/static/assets/js/default-assets/jquery.scrollup.min.js',
    'node_modules/jquery-countdown/dist/jquery.countdown.min.js',
    'node_modules/jquery-nice-select/js/jquery.nice-select.min.js',
    'node_modules/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js',
    'node_modules/jquery-ui-slider/jquery-ui.min.js'
...
// *************************************
// Move Font Awesome Fonts to booking/static/assets/fonts
// *************************************
...
gulp.task('fafonts', function () {
    return gulp.src([
      'node_modules/font-awesome/fonts/*'
        ...
        .pipe(gulp.dest('booking/static/assets/fonts'))
})

// *************************************
// Move Elegant Icons to booking/static/assets/fonts
// *************************************
...
// *******************************
// Move CSS to booking/static/assets/css
// *******************************
...
gulp.task('css', function () {
    return gulp.src([
      ...
      'node_modules/jquery-ui-slider/jquery-ui.min.css'
        ...
        .pipe(gulp.dest('booking/static/assets/css'))
})
